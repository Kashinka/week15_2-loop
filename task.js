...
// Задание 7. Напишите программу, которая выведет все високосные годы в заданном диапазоне. Високосный год является годом, который кратен 4, но не кратен 100, за исключением годов, кратных 400. Используйте цикл for для перебора годов в диапазоне с 2019 и до 2099. Внутри цикла проверьте условие: если год кратен 4, то проверьте дополнительное условие: если год кратен 100, то пропустите этот год с помощью инструкции continue, иначе выведите сообщение "Високосный год: " с найденным годом.
...
//Программа пропустит годы, кратные 100 и не кратные 400, поскольку они не являются високосными