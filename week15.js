...
// не нашла тут массива в задаче, преобразую свой
// let words = ['John', 'Jane', 'Alex', 'Mike'];
// for (let i = 0; i < words.length; i++) {
//     words.forEach((s, i, arr) => arr[i] = s.toUpperCase());//
//     }
// console.log(words)
...
//     if ('aeiou'.includes(greeting[i].toLowerCase())) {
//     vowelCount += 1;
//     }
// }
...
// }
// if (!allPositive) {
//     console.log('Как минимум, один элемент в массиве отрицательный');
// } else {
...
// let h1Headers = document.getElementsByTagName("h4");

// for(let i = 0; i < h1Headers.length; i++) {
//     h1Headers[i].style.color = "red";
// }
